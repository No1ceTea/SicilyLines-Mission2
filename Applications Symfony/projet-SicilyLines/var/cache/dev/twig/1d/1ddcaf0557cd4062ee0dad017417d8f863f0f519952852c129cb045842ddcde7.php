...
class __TwigTemplate_eaf370083bb04c0f15882513ca5ce9ee0d8730b72fdd30a08b940a12df44f5e9 extends Template
{
    private $source;
    private $macros = [];
...
<label<?php if (\$label_attr) { echo ' '.\$view['form']->block(\$form, 'attributes', ['attr' => \$label_attr]); } ?>><?php echo \$view->escape(false !== \$translation_domain ? \$view['translator']->trans(\$label, \$label_translation_parameters, \$translation_domain) : \$label) ?></label>
<?php endif ?>
", "@Framework/Form/form_label.html.php", "/var/www/html/projet-SicilyLines/vendor/symfony/framework-bundle/Resources/views/Form/form_label.html.php");
    }
}
