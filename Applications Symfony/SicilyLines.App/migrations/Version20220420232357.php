 ...
 */
final class Version20220420232357 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE bateau ADD CONSTRAINT FK_A664B05AB13FA634 FOREIGN KEY (proposer_id) REFERENCES proposer (id)');
